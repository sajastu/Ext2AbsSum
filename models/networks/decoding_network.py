...
from models.networks.inference_network import CombinedInferenceNetwork, ContextualInferenceNetwork
...
class DecoderNetwork(nn.Module):
    ...
    def forward(self, src_bow, encoded_sect, labels=None):
        ...
        return self.prior_mean, self.prior_variance, \
            posterior_mu, posterior_sigma, posterior_log_sigma, word_dist, estimated_labels, topic_emb
